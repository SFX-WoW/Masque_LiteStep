...
**Masque: LiteStep** is an add-on for [World of Warcraft](https://worldofwarcraft.com "World of Warcraft") that adds a set of skins for [Masque].

## [Skins][Top]

This set includes the following skins:

- **LiteStep** - A port of the original **LiteStep** skin for [cyCircled].
...
- **Saynt** for the original **LiteStep** skin.
...
[Build]: https://github.com/SFX-WoW/Masque_LiteStep/actions/workflows/build-release.yml (Build Status)
...
[Localization System]: https://www.curseforge.com/wow/addons/masque-litestep/localization (Translate on CurseForge)
...
[SVG-Build]: https://img.shields.io/github/actions/workflow/status/SFX-WoW/Masque_LiteStep/build-release.yml?label=Build&logo=github&logoColor=fff&style=flat-square
